...
`showDusklightRemixTab`. **Protocol is at 17.** Build both sides from the same
...
work), 16 beside all four (the Mods tab, 2026-08-15), and **17 beside all five
(the local point-light mirror removed and `hideStarBillboards` wired,
2026-08-16)**. The next branch to need a number takes **18**. Nothing checks
