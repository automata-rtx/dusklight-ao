...
protocol **2**; the wire has since advanced to **7** (3 = overlay + warp, 4 = the clock, 5 = per-blade grass,
6 = the Controls tab, 7 = effect lights) and gained more keys. The authoritative list is
